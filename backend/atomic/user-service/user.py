...
def _build_openapi_spec(base_url: str) -> dict[str, Any]:
    return {
        "openapi": "3.0.3",
        "info": {
            "title": "TicketBlitz User Service API",
            "version": "1.0.0",
            "description": "User profile retrieval and management endpoints for TicketBlitz services.",
        },
        ...
        "paths": {
            ...
            "/user/{user_id}": {
                "get": {
                    ...
                    "responses": {
                        "200": {
                            "description": "User contract response",
                            "content": {
                                "application/json": {
                                    "schema": {"$ref": "#/components/schemas/UserContract"}
                                }
                            },
                        },
                        "400": {
...
<html lang=\"en\">
  <head>
    ...
    <title>TicketBlitz User Service API Docs</title>
